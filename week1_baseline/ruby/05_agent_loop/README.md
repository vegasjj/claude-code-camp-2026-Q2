...
| `lib/boukensha/backends/azure_foundry.rb` | Azure OpenAI Responses API backend |
...
| `azure_foundry` | `Boukensha::Backends::AzureFoundry` | `AZURE_OPENAI_API_KEY`, `AZURE_OPENAI_ENDPOINT` |
