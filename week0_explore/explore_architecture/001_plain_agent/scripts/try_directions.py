...
def main():
    ...
    # We should currently be at Temple Square (17V) or Temple of Midgaard (if we disconnected/reconnected and it reset/saved?).
    # Wait, let's send 'look' to see where we are first.
    ...
    # Let's execute the directions: s, s, w, n
    commands = ["s", "s", "w", "n", "look", "list"]
    for cmd in commands:
